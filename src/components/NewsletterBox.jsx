  ...
  return (
    <div className="text-center">
      ...
      <p className="text-gray-400 mt-3">
        ...
        delectus vero officia fuga blanditiis saepe corporis suscipit nihil
        voluptatem.
      </p>
      <form onSubmit={onSunbmitHandler} className="w-full sm:w-1/2 flex items-center gap-3 mx-auto my-6 border pl-3">
